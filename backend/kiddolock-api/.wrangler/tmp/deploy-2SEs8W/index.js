...
app.get("/admin", async (c) => {
  ...
  const rows = devices.map((d) => {
    ...
    const namePart = d.device_name ? `<strong style="color:#00e5ff">${d.device_name}</strong><br>${phoneDesc}<br><span style="color:#666;font-size:10px">${idShort}\u2026</span>` : `${phoneDesc}<br><span style="color:#888;font-family:monospace;font-size:11px">${idShort}\u2026</span>`;
    return `
    <tr>
      <td>${namePart}</td>
